    ...
    <section className="pt-6 px-6 pb-16 bg-gray-100 ">
      <div className="max-w-6xl mx-auto">
        ...
        <p className="text-lg text-gray-700 text-center mb-12">
          Explorez nos articles récents, les témoignages de voyageurs, ainsi que
          des conseils pratiques pour planifier votre voyage au Cameroun.
          Découvrez des récits inspirants et des astuces pour rendre votre
          expérience encore plus inoubliable.
        </p>
